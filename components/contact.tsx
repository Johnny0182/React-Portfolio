...
>
      ...
      action={async (formData) => {
        ...
        // goal: add a confetti animation!
      }} 
      >
        <input 
        className="h-14 px-4 rounded-lg borderBlack dark:bg-white dark:bg-opacity-90
        dark:focus:bg-opacity-100 transition-all dark:outline-none dark:hover:bg-white"
        name="senderEmail"
        type="email"
        required
        maxLength={500}
        ...
        <iframe
          ...
          src="https://open.spotify.com/embed/track/700dnb47ud1w4fojNpIjxD?utm_source=generator"
          width="100%"
          height="352"
          frameBorder="0"
