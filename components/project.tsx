    ...
    return (
        ...
        >
            ...
            <section className="bg-gray-100 max-w-[42rem] border border-black/5
                ...
                hover:bg-gray-200 transition rounded-lg dark:bg-white/10 dark:hover:bg-slate-600 dark:text-white">
                ...
                {description}
                    ...
                    uppercase tracking-wider text-white rounded-full dark:text-slate-300" key={index}
                    >
                        {tag}
                    </li>
                ))}
